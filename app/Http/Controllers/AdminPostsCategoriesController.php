...
class AdminPostsCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.postcategories.index', compact('postcategories', 'total', 'page_name'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.postcategories.create', compact('postcategories', 'total', 'page_name'));
    }
    ...
    public function show($slug)
    {
        ...
        return view('admin.postcategories.show', compact('postcategory', 'posts', 'page_name', 'total'));
    }
    ...
    public function edit($slug)
    {
        ...
        $page_name = 'Edit: ' . $postcategory->title;
          ...
          return view('admin.postcategories.edit', compact('postcategory', 'page_name'));
    ...
    public function trashed()
    {
        ...
        return view('admin.postcategories.trashed', compact('postcategories', 'page_name'));
    }
