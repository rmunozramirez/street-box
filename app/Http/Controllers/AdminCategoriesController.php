...
class AdminCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.categories.index', compact('categories', 'total', 'page_name'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.categories.create', compact('categories', 'total', 'page_name'));
    }
    ...
    public function show($slug)
    {
        ...
        return view('admin.categories.show', compact('category', 'page_name', 'total'));
    }
    ...
    public function edit($slug)
    {
        ...
        $page_name = 'Edit: ' . $category->title;
          ...
          return view('admin.categories.edit', compact('category', 'page_name'));
    ...
    public function trashed()
    {
        ...
        return view('admin.categories.trashed', compact('categories', 'page_name'));
    }
